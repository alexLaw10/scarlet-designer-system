  ...
  private renderIcon() {
    switch (this.status) {
      ...
      case 'warning':
        return (
          <svg class="scarlet-alert__icon" part="icon" viewBox="0 0 24 24" aria-hidden="true">
            <polygon points="12,3.5 21,19.5 3,19.5" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round" />
            <line x1="12" y1="10" x2="12" y2="14.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        {this.dismissible ? (
          <button type="button" class="scarlet-alert__dismiss" part="dismiss" aria-label="Fechar" onClick={this.handleDismiss}>
